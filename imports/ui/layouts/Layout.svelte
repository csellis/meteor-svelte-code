        ...
        <div class="{menuOpen ? 'translate-x-0' : '-translate-x-full'} transition ease-in-out duration-300 transform relative flex-1 flex flex-col max-w-xs w-full pt-5 pb-4 bg-cyan-700">
          ...
          <nav class="mt-5 flex-shrink-0 h-full divide-y divide-cyan-800 overflow-y-auto" aria-label="Sidebar">
            <div class="px-2 space-y-1">
              ...
              <NavLink to="/app/dashboard" class="bg-cyan-800 text-white group flex items-center px-2 py-2 text-base font-medium rounded-md">
                <HomeIcon />
                Transactions
              </NavLink>
          ...
          <div class="ml-3 relative">
            <div>
              <button
                ...
                aria-haspopup="true"
              >
                <img class="h-8 w-8 rounded-full" src="https://avatars.githubusercontent.com/u/814405?s=460&u=4e385cdbf6e1ca6426e15cc3f8f9b177c0cbe7ff&v=4" alt="" />
                <span class="hidden ml-3 text-gray-700 text-sm font-medium lg:block"><span class="sr-only">Open user menu for </span>Chris Ellis</span>
            ...
            {#if profileOpen}
              ...
              >
                ...
                <a on:click|preventDefault="{handleLogout}" href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem">Logout</a>
              </div>
            {/if}
          </div>
        </div>
